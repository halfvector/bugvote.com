 ...
 *
 * Usage:
 * $log = LogEntriesCom::getLogger('ad43g-dfd34-df3ed-3d3d3');
...
class LogEntriesCom
{
	...
	public static function getLogger($token, $persistent, $ssl, $severity)
	{
		if (!self::$m_instance)
		{
			self::$m_instance = new LogEntriesCom($token, $persistent, $ssl, $severity);
		}
	...
	{
		$LOGENTRIES_TOKEN = "3a308cd3-e22e-4d11-b3d2-e927a067cb48";
		...
		$log = LogEntriesCom::getLogger($LOGENTRIES_TOKEN, $Persistent, $SSL, $Severity);
